  ...
  services: [
       ...
       than expanding their own mention. ----------------------------------*/
    {
      ...
      blocks: [
        ...
        { type: "marker", text: "DECISION NEEDED, not more research. Findings (31 Aug 2026): AS 3958.1:2007 and AS 3958.2-1992 were amalgamated and redesignated AS 3958:2023 — the other citations in this section have been corrected to the current designation. Every publicly available coverage percentage (the 80%/90%/95%/90-100% spread, incl. tilespec.com.au citing p.84) describes the SUPERSEDED 2007 edition, so none of them can be quoted as current. The 2023 figure is not published anywhere free; it needs the standard itself (purchase from Standards Australia, or free via HIA/MBA membership) or an adhesive manufacturer's post-2023 technical literature citing the clause. Two ways to close this: (1) buy AS 3958:2023 and quote the real figure, or (2) delete this marker and let the preceding paragraph stand as written — it deliberately says \"close to full bed coverage\" and states no percentage, so it is already accurate and sourced without one. Option 2 costs nothing and loses little." },
